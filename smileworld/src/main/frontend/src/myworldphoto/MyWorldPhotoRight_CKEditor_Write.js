...
const MyWorldPhotoRight_CKEditor_Write = (props) => {
    ...
    const [title, setTitle] = useState(() => sessionStorage.getItem("photoKey") === '1' ? (sessionStorage.getItem("ckTitle_photo")) : "");
    const [content, setContent] = useState(() => sessionStorage.getItem("photoKey") === '1' ? (sessionStorage.getItem("ckContent_photo")) : ""); //sessionStorage.getItem("ckContent")
    ...
    const onSubmitPhoto = () => {
        ...
        //alert(data);
            ...
            axios.post("/writePhotoBoard", null, {
                params: {
                    board_title: title,
    ...
    const onChangePhotoTitle = (e) => {
        ...
        sessionStorage.setItem("ckTitle_photo", e.target.value)
        sessionStorage.setItem("photoKey", "1");
    }
                    ...
                    <div className="picContentEdit">
                        <CKEditor
                            ...
                            onChange={(event, editor) => {
                                ...
                                setContent(data2)
                                //alert(data2)
                                sessionStorage.setItem("ckContent_photo", data2)
                                sessionStorage.setItem("photoKey", "1");
                            }}
                        />
...
export default React.memo(MyWorldPhotoRight_CKEditor_Write)